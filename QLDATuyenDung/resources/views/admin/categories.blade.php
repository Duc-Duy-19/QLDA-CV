...
<div class="admin-content">
    <style>
        ...
        /* Table */
        .table-container { background: #fff; padding: 14px; border-radius: 8px; box-shadow: 0 1px 3px rgba(20,20,20,0.04); }
        .admin-table { width: 100%; border-collapse: collapse; font-size: 14px; }
        .admin-table thead th {
            text-align: left; padding: 10px 12px; font-weight: 700; color: #4a5568; border-bottom: 2px solid #edf2f7;
        }
        .admin-table tbody td { padding: 12px; border-bottom: 1px solid #f1f5f9; vertical-align: middle; }
        ...
        /* Modal */
        .modal { display: none; position: fixed; z-index: 1200; left: 0; top: 0; width: 100%; height: 100%; overflow: auto; background: rgba(15, 23, 42, 0.45); }
        .modal-content { background: #fff; margin: 6% auto; border-radius: 8px; width: 420px; max-width: calc(100% - 40px); box-shadow: 0 10px 30px rgba(2,6,23,0.2); overflow: hidden; }
        ...
        .close { background: transparent; border: none; font-size: 20px; cursor: pointer; color: #718096 }

        /* Form */
        .form-group { margin-bottom: 12px; }
        .form-group input[type="text"], .form-group input[type="email"], .form-group textarea {
            width: 100%; padding: 10px 12px; border: 1px solid #e2e8f0; border-radius: 6px; background: #fff; color:#2d3748;
            box-sizing: border-box; font-size: 14px;
        }
        .form-group.with-icon { position: relative }
        .form-icon { position: absolute; right: 12px; top: 50%; transform: translateY(-50%); color: #a0aec0 }
        ...
        @media (max-width: 600px) {
            ...
            .admin-table td::before { content: attr(data-label); position: absolute; left: 12px; width: calc(50% - 24px); text-align: left; font-weight:600; color:#4a5568 }
        }
    </style>
    <!-- Add Category Button -->
    <div class="mb-4">
